...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_LALT, GUI_T(KC_LANG2), KC_NUMS, KC_FN, KC_LANG1, JP_BSLS
  ),
  [_NUMS] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______, KC_HOME, KC_END, KC_PGUP, KC_PGDOWN, KC_LEFT, KC_DOWN, KC_RIGHT,
