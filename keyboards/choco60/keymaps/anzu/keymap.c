...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    GUI_T(KC_TAB), KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRACKET, KC_RBRACKET, KC_BSLASH, 
    ...
    KC_LALT,  KC_LGUI, LT(_FN, KC_SPACE), KC_BSPACE, LT(_FN, KC_SPACE), KC_RGUI, KC_RALT
  ),
  [_FN] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______, KC_HOME, KC_END, KC_PGUP, KC_PGDOWN, KC_DOWN, KC_RSHIFT, KC_FN,
