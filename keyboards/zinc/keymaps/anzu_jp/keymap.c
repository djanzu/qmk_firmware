...
[_QWERTY] = LAYOUT_ortho_4x12(
      ...
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                      KC_N,    KC_M,    KC_COMM, KC_DOT, KC_UP, KC_LBRC, KC_RBRC , \
      FN1,  _FN1, KC_LALT, KC_LGUI, KC_LANG1, LT(NUM, KC_SPC),                    KC_ENT, KC_LANG2, JP_BSLS , KC_LEFT, KC_DOWN,  KC_RGHT \
      ),
