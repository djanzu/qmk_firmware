...
[_QWERTY] = LAYOUT_ortho_4x12(
      ...
      CTL_T(KC_TAB), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,             KC_H,    KC_J,    KC_K,    KC_L,    KC_LCBR, KC_RCBR, \
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                   KC_N,    KC_M,    KC_SCLN, KC_QUOT, KC_UP,   KC_SLSH, \
      KC_LGUI, KC_LALT, ADJUST, KC_MINS, KC_UNDS,  LT(_RAISE, KC_SPC),     KC_ENT,  KC_COMM, KC_DOT , KC_LEFT, KC_DOWN, KC_RGHT \
      ),
