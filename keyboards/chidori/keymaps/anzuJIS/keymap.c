...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT3(
      LT(_ADJUST, KC_ESC), KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,              KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,         KC_1,    KC_2,    KC_3,      KC_4,    KC_5,    KC_GRV,
      CTL_T(KC_TAB),       KC_A,    KC_S,    KC_D,    KC_F,    KC_G,              KC_H,    KC_J,    KC_K,    KC_L,    JP_SCLN, JP_COLN,         KC_6,    KC_7,    KC_8,      KC_9,    KC_0,    KC_BSLS,
      KC_LSFT,             KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,              KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_UP,   KC_SLSH,         KC_PGUP, KC_UP,   KC_PGDOWN, KC_HOME, KC_MINS, KC_EQL,
      GUI_T(JP_BSLS),      KC_LALT, JP_YEN,  JP_LBRC, JP_RBRC, KC_SPC,            LT(_RAISE, KC_ENT), JP_MINS, JP_BSLS, KC_LEFT, KC_DOWN, KC_RGHT,         KC_LEFT, KC_DOWN, KC_RIGHT,  KC_END,  KC_LBRC, KC_RBRC
    ),
    [_COLEMAK] = LAYOUT3(
    ...
    [_LOWER] = LAYOUT3(
      ...
      _______, _______, _______, _______, _______, _______,           _______, KC_QUOT, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY,       KC_P0,   _______, KC_PDOT,_______, KC_PMNS, KC_BSPC
    ),
    [_RAISE] = LAYOUT3(
      ...
      _______, _______, _______, _______, _______, _______,           _______, KC_GRV, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY,       KC_P0,   _______, KC_PDOT,_______, KC_PMNS, KC_BSPC
    ),
    [_ADJUST] = LAYOUT3(
